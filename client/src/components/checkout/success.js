...
<Grid container spacing={2} direction="column" alignItems="center" style={{'marginTop':'100px'}}>
        ...
        <Table size="small" aria-label="a dense table">
          ...
          <TableBody>
            ...
            <TableRow>
                ...
                <TableCell></TableCell>
                <TableCell></TableCell>
                <TableCell align='right'><h5 style={{'color':'red'}}><b>${totalpedido.toFixed(2).replace(".",",")}</b></h5></TableCell>
            </TableRow>
          </TableBody>
        </Table>
      </TableContainer>
      ...
      <Grid item>
        <ButtonOne style={{'width':'100px'}} onClick={() => navigate('/')}>inicio</ButtonOne>
      </Grid>  
      <Grid item>
        <ButtonOne style={{'width':'100px'}} color='primary' onClick={() => window.print() }>Imprimir</ButtonOne>
      </Grid>
      <Grid item>
      <div style={{'color':'grey'}}>Entrega: {pedido.delivery === true ? "Delivery" : "Retiro en sucursal" }</div>
      <div style={{'color':'grey'}}>Pagado: { pedido.payd === true ? "El pedido ha sido pagado" : "El pedido será abonado al recibirlo" }</div>
      </Grid>
      </Grid>
    </>
}
